...
A simple terminal app that lets you open a bank account and deposit or transfer money. Card numbers are generated with the Luhn algorithm. The data is stored in an SQLite database.
